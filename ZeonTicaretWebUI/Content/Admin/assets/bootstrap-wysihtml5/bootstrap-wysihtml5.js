    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn btn-default dropdown-toggle" + size + "' data-toggle='dropdown' href="~/Content/Zeon'#'>" +
            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "<div class='modal-footer'>" +
                  "<a href="~/Content/Zeon'#' class='btn btn-default' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
                  "<a href="~/Content/Zeon'#' class='btn btn-primary' data-dismiss='modal'>" + locale.link.insert + "</a>" +
                "</div>" +
              "</div>" +
              "</div>" +
              "</div>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "</div>" +
                "<div class='modal-footer'>" +
                  "<a href="~/Content/Zeon'#' class='btn btn-default' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
                  "<a href="~/Content/Zeon'#' class='btn btn-primary' data-dismiss='modal'>" + locale.image.insert + "</a>" +
                "</div>" +
              "</div>" +
              "</div>" +
              "</div>" +
        ...
        "color": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li class='dropdown'>" +
              "<a class='btn btn-default dropdown-toggle" + size + "' data-toggle='dropdown' href="~/Content/Zeon'#' tabindex='-1'>" +
